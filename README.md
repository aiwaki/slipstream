...
1. В [Releases](https://github.com/aiwaki/slipstream/releases) выбрать самый свежий релиз `Slipstream`, отмеченный как **Pre-release**, и загрузить `Slipstream-macos-arm64.zip`.
