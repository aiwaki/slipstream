...
| Strategy cache and policy | bounded/versioned cache plus explicit policy tables and diagnostic policy hash | signed remote strategy list |
...
- Move explicit host policy, attempt limits, and policy hash into a signed update
  format.
