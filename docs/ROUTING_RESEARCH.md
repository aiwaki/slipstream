...
atomic effect: it retains exact bytes after packet-flow acceptance, preserves
...
packet-flow high watermark. Both paths reject stale evidence. The selected stack is still not
