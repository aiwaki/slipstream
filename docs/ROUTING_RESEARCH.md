...
verification. Every active byte-owner transition preserves that complete
admission capability. Userspace byte-owner v1 now bridges actual payload through an injected
