...
Continue M4 on disposable systems. PR #193's head proved no-payload IPv4
...
After exact-main verification, add the equivalent isolated IPv6 selection
subgate using host-order `IPV6_UNICAST_IF`; do not combine it with packet
delivery. Actual packet delivery, fresh
