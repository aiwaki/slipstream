...
[PR #194](https://github.com/aiwaki/slipstream/pull/194) at main commit
`a37342000643f0325b930d2cd57d34c3238809ef`, including its successful
[native AMD64/ARM64 run 29773208168](https://github.com/aiwaki/slipstream/actions/runs/29773208168),
[required CI run 29773207895](https://github.com/aiwaki/slipstream/actions/runs/29773207895),
and
[dependency-audit run 29773208142](https://github.com/aiwaki/slipstream/actions/runs/29773208142).
...
- Prove closed IPv4 and IPv6 packet delivery as separate gates under a competing
  capture route on disposable native AMD64 and ARM64 Windows runners;
  no-payload interface selection is already exact-main qualified.
