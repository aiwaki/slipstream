...
`90c07771babfd32e797fdb8250911ca922274b4d`. PR #258 corrected the disposable
Chromium incomplete-response fixture so its HTTP/1.1 handler actually closes
after the deliberately short body, and added a real TLS keep-alive regression
that receives the exact prefix as `IncompleteRead`. Exact-main CI
`30431655863` and audit `30431655851` passed on that SHA.
