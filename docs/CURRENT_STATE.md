...
[PR #192](https://github.com/aiwaki/slipstream/pull/192) at main commit
`924f91168e1b751dcd95b59ff442d6a862ac57e0`, including its successful
[native AMD64/ARM64 run 29735735809](https://github.com/aiwaki/slipstream/actions/runs/29735735809),
[required CI run 29735735842](https://github.com/aiwaki/slipstream/actions/runs/29735735842),
and
[dependency-audit run 29735735751](https://github.com/aiwaki/slipstream/actions/runs/29735735751).
...
Continue M4 on disposable systems. PR #192 proved that its separately owned
Wintun address and exact route are both removed on native AMD64 and ARM64. Add
the next disposable no-payload IPv4 socket-selection fixture under that
competing capture route. It must retain the original kernel-selected egress
interface and source, set and read back `IP_UNICAST_IF`, bind the source
explicitly, and never use the capture interface or send a packet. Native AMD64
and ARM64 must pass before this subgate qualifies. IPv6 selection, actual
packet delivery, fresh
...
- Prove actual IPv4/IPv6 outbound interface binding with a competing capture
  route on disposable native AMD64 and ARM64 Windows runners; the pure egress
  contract alone is not loop-avoidance evidence.
