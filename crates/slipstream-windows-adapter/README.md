...
consumes StatusV2, and classifies traffic without calling Windows or touching
the host.
...
Native service-manager, process, storage, DNS, proxy, VPN, packet, and installer
effects belong in later modules and must keep both v1 recording harnesses
...
`contracts/windows-service-lifecycle-v1.json`, and the existing routing,
